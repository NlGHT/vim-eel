...
" Acknowledgement: Based off of YATS: Yet Another TypeScript Syntax maintained by Herrington Darkholme https://github.com/HerringtonDarkholme/yats.vim
" (Really all I have done is replace the "{" swirly brackets with "("). I can't find any resources on indentation and it works so... nice :)
